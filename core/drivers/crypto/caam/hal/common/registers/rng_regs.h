...
#define BM_TRNG_SDCTL_SAMP_SIZE		SHIFT_U32(0xFFFF, 0)
#define GET_TRNG_SDCTL_SAMP_SIZE(val)	((val) & (BM_TRNG_SDCTL_SAMP_SIZE))
#define TRNG_SDCTL_SAMP_SIZE(val)	SHIFT_U32(((val) & (0xFFFF)), 0)
