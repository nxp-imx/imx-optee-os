...
static const struct smallprime smallprimes[] = {
	...
	/*  bits / bytes |         |                         */
	/*    64 / 8     |   15    |          53   |    72   */
	{ .data = (uint8_t[]){ 0xe2, 0x21, 0xf9, 0x7c, 0x30, 0xe9, 0x4e, 0x1d },
	  .length = 8 },
	/*   128 / 16    |   25    |          101  |    76   */
	{ .data = (uint8_t[]){ 0x57, 0x97, 0xd4, 0x7c, 0x51, 0x68, 0x15, 0x49,
			       0xd7, 0x34, 0xe4, 0xfc, 0x4c, 0x3e, 0xaf, 0x7f },
	  .length = 16 },
	/*   256 / 32    |   43    |          193  |    79   */
	{ .data = (uint8_t[]){ 0xdb, 0xf0, 0x5b, 0x6f, 0x56, 0x54, 0xb3, 0xc0,
			       0xf5, 0x24, 0x35, 0x51, 0x43, 0x95, 0x86, 0x88,
			       0x9f, 0x15, 0x58, 0x87, 0x81, 0x9a, 0xed, 0x2a,
			       0xc0, 0x5b, 0x93, 0x35, 0x2b, 0xe9, 0x86, 0x77 },
	  .length = 32 },
	/*   384 / 48    |   59    |          281  |    80   */
	{ .data = (uint8_t[]){ 0x50, 0x12, 0x01, 0xcc, 0x51, 0xa4, 0x92, 0xa5,
	  ...
	  .length = 48 },
	/*   512 / 64    |   74    |          379  |    81   */
	{ .data = (uint8_t[]){ 0x10, 0x6a, 0xa9, 0xfb, 0x76, 0x46, 0xfa, 0x6e,
	  ...
	  .length = 64 },
	/*   576 / 72    |   81    |          421  |    82   */
	{ .data = (uint8_t[]){ 0x01, 0x85, 0xdb, 0xeb, 0x2b, 0x8b, 0x11, 0xd3,
	...
	{ .data =
		  (uint8_t[]){
			  0x25, 0xea, 0xc8, 0x9f, 0x8d, 0x4d, 0xa3, 0x38, 0x33,
			  0x7b, 0x49, 0x85, 0x0d, 0x2d, 0x14, 0x89, 0x26, 0x63,
			  0x17, 0x7b, 0x40, 0x10, 0xaf, 0x3d, 0xd2, 0x3e, 0xeb,
			  0x0b, 0x22, 0x8f, 0x38, 0x32, 0xff, 0xce, 0xe2, 0xe5,
			  0xcb, 0xd1, 0xac, 0xc9, 0x8f, 0x47, 0xf2, 0x51, 0x87,
			  0x33, 0x80, 0xae, 0x10, 0xf0, 0xff, 0xdd, 0x8e, 0x60,
			  0x2f, 0xfa, 0x21, 0x0f, 0x41, 0xf6, 0x69, 0xa1, 0x57,
			  0x0a, 0x93, 0xc1, 0x58, 0xc1, 0xa9, 0xa8, 0x22, 0x7f,
			  0xf8, 0x1a, 0x90, 0xc5, 0x63, 0x0e, 0x9c, 0x44, 0x84,
			  0x5c, 0x75, 0x5c, 0x7d, 0xf3, 0x5a, 0x7d, 0x43, 0x0c,
			  0x67, 0x9a, 0x11, 0x57, 0x56, 0x55,
		  },
	  .length = 96 },
	/*  1024 / 128   |  130    |          739  |    83   */
	{ .data =
		  (uint8_t[]){
			  ,
		  },
	  .length = 128 },
	/*  1088 / 184   |  136    |          787  |    83   */
	{ .data = (uint8_t[]){ 0x16, 0xaf, 0x5c, 0x18, 0xa2, 0xbe, 0xf8, 0xef,
	...
	{ .data = (uint8_t[]){ 0x02, 0x1b, 0xf9, 0x49, 0x70, 0x91, 0xb8, 0xc3,
	...
	{ .data =
		  (uint8_t[]){
			   },
	  .length = 256 },
	/*  3072 / 384   | 326     |          2179  |    85   */
	{ .data =
		  (uint8_t[]){
			   },
	  .length = 384 },
	/*  4096 / 512   | 417     |          2887  |    86   */
	{ .data =
		  (uint8_t[]){
			  ,
				      ...
				      const paddr_t desc_prime)
{
	...
	caam_desc_add_word(desc, 500000);
